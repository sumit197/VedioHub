      ...
      <Stack direction={["column", "row"]} h={"100vh"}>
        <VStack w={"full"}>
          <video
            ...
            style={{ width: "100%" }}
          ></video>
          <VStack alignItems={'flex-start'} w={'100%'} p={'8'} overflowY={'auto'}>
          <Heading>Sample Video 1</Heading>
          <Text>this is sample video for testing and demo.This is called discription</Text>
          </VStack>
        </VStack>
        <VStack w={["full", "xl"]} alignItems={'stretch'} overflowY={'auto'} p={'8'} spacing={'8'}>
            {
